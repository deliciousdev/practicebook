...
public class MyQ10825_2 {
    ...
    static class Person implements Comparable<Person> {
        ...
        public int compareTo(Person o) {
            if (this.korean != o.korean) return this.korean > o.korean ? -1 : 1;
            if(this.english != o.english) return this.english > o.english ? 1: -1;
            if(this.math != o.math) return this.math > o.math ? -1: 1;
