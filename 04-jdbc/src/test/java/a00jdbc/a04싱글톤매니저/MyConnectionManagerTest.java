...
class MyConnectionManagerTest {
    ...
    void setUp(){
        ...
        DatabasePopulatorUtils.execute(populator, MyConnectionManager.INSTANCE.getDataSource());//HikariCP 는 hikariDatasource 가져올때 사용됨
    }
